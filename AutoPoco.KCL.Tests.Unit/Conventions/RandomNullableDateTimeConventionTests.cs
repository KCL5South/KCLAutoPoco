...
{
	[TestFixture]
	public class RandomNullableDateTimeConventionTests
	{
		[Test]
		public void Apply()
		{
			Mock<ITypePropertyConventionContext> contextMock = new Mock<ITypePropertyConventionContext>();
			var target = new RandomNullableDateTimeConvention();

			target.Apply(contextMock.Object);

			contextMock.Verify( a => a.SetSource<RandomNullableDateTimeDataSource>(), @"
...
");
		...
		public void SpecifyRequirements()
		{
			...
			reqMock.Verify(a => a.Type(x => x == typeof(System.Nullable<System.DateTime>)), @"
...
");
		...
		{
			public System.DateTime? TargetProperty { get; set; }
		}
		...
		public void IntegrationTest()
		{
			var mFactory = AutoPocoContainer.Configure(x =>
			{
				x.Conventions(c =>
				{
					c.Register<RandomNullableDateTimeConvention>();
