...
{
	[TestFixture]
	public class RandomDateTimeConventionTests
	{
		[Test]
		public void Apply()
		{
			...
			contextMock.Verify( a => a.SetSource<RandomDateTimeDataSource>(), @"
...
");
		...
		public void SpecifyRequirements()
		{
			...
			reqMock.Verify(a => a.Type(x => x == typeof(System.DateTime)), @"
...
");
		...
		public void IntegrationTest()
		{
			var mFactory = AutoPocoContainer.Configure(x =>
			{
				x.Conventions(c =>
				{
					c.Register<RandomDateTimeConvention>();
