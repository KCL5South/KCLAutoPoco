...
namespace AutoPoco.KCL.DataSources
{
	...
	public class RandomInt32DataSourceTests
	{
		...
		public void Next()
		{
			...
			var target = new RandomInt32DataSource(randMock.Object);
			target.Next(null);

			randMock.Verify(a => a.GetInt32(System.Int32.MinValue, System.Int32.MaxValue), @"
The GetInt32 method on the IRandomExtensions object was not called.
");
		}
	}
}